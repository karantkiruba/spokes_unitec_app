...
//                                                                                            newoption.push(task.series_list[i].series_name);
						...
						//if(frm.get_docfield('unit_doc_type')&& frm.doc.naming_series_manager !== '' && frm.doc.naming_series_definition !== '')
							...
							if(def.message[j].source_warehouse){
								if(cur_frm.doc.doctype === "Transfer Out"){
									cur_frm.set_value('set_warehouse', def.message[j].source_warehouse)
								}
								if(cur_frm.doc.doctype === "Sales Invoice" || cur_frm.doc.doctype === "Purchase Invoice" || cur_frm.doc.doctype === "Delivery Note" || cur_frm.doc.doctype === "Sales Order"
									    ||	cur_frm.doc.doctype === "Purchase Order" || cur_frm.doc.doctype === "Purchase Receipt"
											||  cur_frm.doc.doctype === "Material Request"){
                                                                        cur_frm.set_value('set_warehouse', def.message[j].source_warehouse)
                                                                }
								 if(cur_frm.doc.doctype === "Work Order"){
                                                                        cur_frm.set_value('source_warehouse', def.message[j].source_warehouse)
                                                                }
							...
							if(def.message[j].target_warehouse){
								 if(cur_frm.doc.doctype === "Transfer Out"){
									cur_frm.set_value('target_warehouse', def.message[j].target_warehouse)
									}
                                                                 if(cur_frm.doc.doctype === "Work Order"){
                                                                        cur_frm.set_value('fg_warehouse', def.message[j].target_warehouse)
                                                                        }
